...
function buildPriceList(destination) {
    ...
    $.each(flights, function (i, flight) {
        var flightRecord = flight.price + " " + flight.outbound.fltNbr+" "+ flight.outbound.date + " " + flight.outbound.time + " " + flight.outbound.duration + "\b" +
            flight.inbound.fltNbr+" "+ flight.inbound.date + " " + flight.inbound.time + " " + flight.inbound.duration;
